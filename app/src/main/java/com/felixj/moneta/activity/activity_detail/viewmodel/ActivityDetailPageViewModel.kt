package com.felixj.moneta.activity.activity_detail.viewmodel
...
class ActivityDetailPageViewModel @AssistedInject constructor(
    ...
    fun onUserEvent(userEvent: ActivityDetailPageUserEvent) {
        when (userEvent) {
            ...
            ActivityDetailPageUserEvent.EditClick -> viewModelScope.launch {
                _uiEvent.emit(ActivityDetailPageUiEvent.NavigateToEdit(navKey.activityId))
            }
